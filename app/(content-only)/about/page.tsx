      ...
      >
        ...
        >
          {[0,1,2].map(i => (
            <motion.li
              key={i}
              className="flex flex-col items-center justify-center gap-2 w-1/3 bg-background-muted rounded-lg p-4 shadow-md"
              variants={scaleIn}
            ...
            >
              ...
              <p className="text-xs text-center">
                {i===0 && <>만화, 시나리오 작가 등<br/>서사 기반 창작자</>}
                {i===1 && <>캐릭터 정보를 시각화하는<br/>디자이너, 일러스트레이터</>}
                {i===2 && <>오리지널 캐릭터를 만드는<br/>모든 크리에이터</>}
              </p>
            </motion.li>
          ))}
        </motion.ul>
      ...
      >
        <div className="w-full h-svh flex flex-col gap-4">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <motion.div className="flex flex-col flex-1" variants={fadeInUp}>
            ...
            <motion.div className="flex flex-col flex-1 items-center justify-center" variants={scaleIn}>
              <CarouselCard />
            </motion.div>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            <motion.div className="flex flex-1 items-center justify-center" variants={scaleIn}>
              <Image
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                각 30개의 캐릭터 프로필 슬롯과 세계관 슬롯을 기본 제공합니다.<br/>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                A.  가능합니다. 모든 캐릭터는 공개 여부를 개별 설정하실 수 있으며, <br/>
