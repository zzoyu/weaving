...
function RelationshipCard() {
  return (
    ...
    <motion.div
      ...
      transition={{ duration: 0.8, ease: "easeInOut", animation: {
        type: "spring",
        damping:-30,
        stiffness: 0,
        duration: 0.4,
    ...
    {relationshipImages.map((src, i) => {
      ...
      return (
        <motion.div
          ...
          initial={{ opacity: 0, y: 0, x: 0, scale: 0.8, rotate: 0, rotateX: 0, rotateY: 0 }}
          whileInView={{ opacity: 1, y, x, scale: 1, rotate: 0, rotateX: 0, rotateY: 0,
            transition: {
              duration: 0.4 + i * 0.2,
              ease: "easeInOut",
              delay: i * 0.2
  ...
  return (
    <div className="w-full py-40 relative mb-40">
      ...
      <motion.div 
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: false, amount: 0.3 }}
        transition={{ duration: 0.8, ease: "easeOut", staggerChildren: 0.2, delay: 0.6 }}
      >
